        ...
        <div className='bg-purple-100 shadow-md border-b-[0.5px] border-gray-300  '>
           <Container>
            <nav className='px-8 py-4 flex justify-between items-center container mx-auto'>
                    <h1 className='md:text-xl text-sm font-bold'>PH:Univesity</h1>
                    <div className='md:flex hidden items-center gap-6'>
                       ...
                       <button className='bg-purple-600 text-white px-4 py-2 rounded-lg hover:cursor-pointer'>+ New Assignment </button>
